...
import { View, YellowBox, ScrollView, KeyboardAvoidingView, Alert,ImageBackground,Button } from 'react-native';
...
export default class UpdateUser extends React.Component {
  ...
  updateUser = () => {
    ...
    if (user_name){
            ...
            tx.executeSql(
              ...
              (tx, results) => {
                ...
                if(results.rowsAffected>0){
                  Alert.alert( 'Success', 'Sửa thành công !',
                    [
      ...
      alert('Hãy điền nội dung ghi chứ !');
    }
  };
      ...
      <View style={{ backgroundColor: '#BEF781', flex: 1 }}>
        ...
        <ScrollView keyboardShouldPersistTaps="handled">
          <KeyboardAvoidingView
            ...
            <Mytextinput
              placeholder="Nhập ID của ghi chú cần sửa !"
              style={{ padding:10 }}
              onChangeText={input_user_id => this.setState({ input_user_id })}
            />
            <Mybutton
              title="Lấy thông tin cần sửa !"
            ...
            <Mytextinput
              ...
              placeholder="Nội dung của ghi chú !"
